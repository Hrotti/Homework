...
That means things like negative speed is completele possible.
*/
...
IN CONSTRUCTOR
    ...
    //Things at the point of calculation will either be:
    ...
    this.cooldownRate = 1;
    this.cooldownAdj = 0;//Calculated PER ABILITY
NEW FUNCTIONS
...
/**
 * Some premade buffs to use. I can expand it later.
 */
const PremadeBuffs = {
